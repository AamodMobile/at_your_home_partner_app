          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                color: widget.borderCl ?? borderColorCont,
              ),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.borderRadius ?? 12),
              borderSide: BorderSide(
                color: widget.borderCl ?? mainColor,
              ),
            ),
            ...
            isDense: true,
            suffixIcon: widget.leading1 == null ? null :
            Padding(padding: const EdgeInsets.symmetric(horizontal: 8), child: widget.leading1!),
